...
const Header = () => {
    ...
    const Menu = [
        { label: '홈', path: '/' },
        { label: '인형', path: '/#figures' },
        { label: '디지털', path: '/#digital' },
        { label: '문구', path: '/#stationery' },
        { label: '생활', path: '/#lifestyle' },
    ];
        ...
        <header className={styles.header}>
            <div className={styles.headerContent}>
                ...
                {user ? (
                    ...
                    <>
                    {/* 유저가 없을 때 */}
                    <span className={styles.loginText} onClick={() => navigate('/login')}>Login</span>
                    <a href="#notifications">
                        <img src={noticeIcon} alt="Notifications" className={styles.icon} />
                    </a>
                    <a href="#cart">
